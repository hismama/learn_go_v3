...
func main() {
	...
	bond["fleming_ian"] = []string{"steaks", "cigars", "espionage"}
	for k, v := range bond {
		fmt.Println(k)
		for i, r := range v {
			fmt.Println(i, r)
	...
	gatsby := []string{"in", "my", "younger", "and", "more", "vulnerable", "years", "my", "father", "gave", "me", "some",
